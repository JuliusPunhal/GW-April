...
namespace April {
	...
	enum class Reaper : char {
		Lab, Vale, Wastes, Pits, Plains, Mnts, Pools
	};

	struct ReaperName {
		std::array<wchar_t, 4> name;
	};
	constexpr auto operator==( wchar_t const* name, ReaperName const& reaper )
	{
	...
	inline constexpr std::array<ReaperName, 7> ReaperNames{
		...
		0x3627, 0x9440, 0xB651, 0x6C09, // Plains
		0x3623, 0xEC03, 0xC5E5, 0x5BF9, // Mnts
		0x3629, 0xDD53, 0xE104, 0x4B27, // Pools
	};

	constexpr auto GetReaperByName( wchar_t const* name )
		-> std::optional<Reaper>
	{
